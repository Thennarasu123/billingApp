...
import 'rsuite';
import { FaHeart, FaBars, FaSave, FaLessThanEqual, FaLayerGroup, FaPencilAlt , FaPrint, FaTrash, FaVoteYea, FaEdit, FaRegEnvelope, FaUserTie} from 'react-icons/fa';
...
class App extends Component {
    constructor(props){  
     ...
     /*  itemsData:tableItemsData, */
      ...
      currentStep:'Document Details',
      lineItemRows : [{id:'0001',desc:'',unit:'',unitPrice:'',qty:'',total:''},{id:'',desc:'',unit:'',unitPrice:'',qty:'',total:''},{id:'',desc:'',unit:'',unitPrice:'',qty:'',total:''},{id:'',desc:'',unit:'',unitPrice:'',qty:'',total:''},{id:'',desc:'',unit:'',unitPrice:'',qty:'',total:''}],
      ...
      total:'',
      Qaddress1:'',
      Qaddress2:'',Qaddress3:'',Qaddress4:'',Qaddress5:'',QaddressTel:'',QaddressTel:'',QaddressVAT:'',addNewRow:false};  
    ...
    handlePDFPreview = () => () => {
        ...
        var createPDF = function(imgData) {
          ...
          doc.addImage(imgData, 'JPEG', 2, 5, doc.internal.pageSize.width-2, 28, 'monkey'); // Cache the image using the alias 'monkey'
        ...
        autoTable(doc, { html: '#my-table', theme:'grid',startY:105,/* rowStyles:{1:{backgroundColor:'red'}} *//* bodyStyles: {halign: 'center', fillColor: [151, 154,  170]}, */ footStyles: {cellWidth: 'wrap',
        fontSize: 10,
        lineWidth: 0,
        lineColor: [0, 0, 0],
        textColor: [0, 0, 0],
        ...
        //var Notes = document.createElement('P');
        doc.setFontSize(10);
        doc.text("Date : ",10,263)
        ////doc.text(text,25,243);
        var Notes = 'Notes : This is a Sample Note with Italic and Underlined Fonts';
        doc.setFontSize(12);
        doc.text(Notes, 12, 230)
    ...
    handleCurrencyChange  = (e) => {
     ...
     render(){
      ...
      const { column, data, direction,supplierData,itemsData,quotationData,quotationTrashData,lineItemsArray } = this.state
...
<> */        <div>
  ...
  <tbody>
      <tr>
          <td>{this.state.id1}</td>
          <td>{this.state.desc1}</td>
          <td>{this.state.unit1}</td>
          <td>{this.state.unitPrice1}</td>
          <td>{this.state.Qty1}</td>
          <td>{this.state.total1}</td>
      </tr>
      <tr>
          <td>{this.state.id2}</td>
          <td>{this.state.desc2}</td>
          <td>{this.state.unit2}</td>
          <td>{this.state.unitPrice2}</td>
          <td>{this.state.Qty2}</td>
          <td>{this.state.total2}</td>
      </tr>
      <tr>
          <td>{this.state.id3}</td>
      ...
      <td>{this.state.payTerm}</td>
          ...
          <div className="ms-Grid-row">
            ...
            <Table responsive celled selectable sortable  className="QuotationItems" id="QuotationItems"> 
              ...
              {_.map(this.state.lineItemRows, ( { id, desc, qty, unit, unitPrice, total},index) => (
                  <Table.Row key={id}>
                    ...
                    <Table.Cell><Button variant="danger" onClick={(e) => {this.deleteLineItemsRow(index)}} id={"itemDelete"+(index+1)} value="DELETE">X</Button></Table.Cell>
                  </Table.Row>
              ))}
                  {/* <Table.Row>
              ...
              {<Table.Footer>
                <Table.Row>
                  <Table.HeaderCell colSpan="1" style={{textAlign:'right'}}><Button variant="secondary" id='lineItemsRowAdd' onClick={() => {this.setState({stateVar:this.state})}}>Add</Button>
                  </Table.HeaderCell>
            ...
            <div id="signatureBox">
              ...
              <label><input type="checkbox" id="lhsSignCheck"/> LHS Signature  </label>
                  <FilePicker
                    ...
                    <label for="lhsSignDate">
                  <input type="checkbox" id="lhsSignDateCheck"/> Date: <input type="date" />
                  </label>
              </div>
              <div id="rhsSign">
      ...
      //handleQuotationSave = (el) => () => {
        $(document).ready(function(){
          $(document).on('click','#lineItemsRowAdd',function(e){
            ...
            //$("<tr><td></td><td></td></tr>").appendTo("#QuotationItems > tbody");
